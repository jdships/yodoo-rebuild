  ...
  return (
    ...
    >
      <div className="flex flex-1 items-center">
        <span className="line-clamp-1 font-normal text-sm">{chat.title}</span>
        <input
          autoFocus
    ...
    <>
      ...
      <div className="relative flex min-w-[140px] flex-shrink-0 items-center justify-end">
        ...
        <div className="absolute right-0 flex translate-x-1 gap-1 opacity-0 transition-all duration-200 group-hover:translate-x-0 group-hover:opacity-100">
          ...
          >
            {chat.pinned ? (
              <PinOff className="size-3 stroke-[1.5px] transition-colors duration-150 group-hover/edit:text-primary" />
            ) : (
              <Pin className="size-3 stroke-[1.5px] transition-colors duration-150 group-hover/edit:text-primary" />
            )}
          </Button>
          ...
          >
            ...
            >
              ...
              {!searchQuery && pinnedChats.length > 0 && (
                <CommandGroup
                  heading={
                    <div className="flex items-center gap-1 break-all font-semibold">
