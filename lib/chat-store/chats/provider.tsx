...
export function ChatsProvider({
  ...
  const createNewChat = async (
    ...
    try {
      ...
      // Handle usage limit errors gracefully - don't show generic error
      if (error instanceof Error && (error as any).code === "USAGE_LIMIT_ERROR") {
        // The usage limit toast is already shown in use-chat-operations.ts
        return
      }
